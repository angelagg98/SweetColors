-- =====================================================================
-- SweetColors - Productos de ejemplo (datos simulados)
-- Precios en pesos colombianos. Incluye productos sin stock para poder
-- probar el aviso de "sin stock" de la lista de deseos.
-- Los usuarios NO se cargan aquí: se crean desde la pantalla de Registro
-- para que la contraseña se guarde con hash.
-- =====================================================================
USE catalog_db;
